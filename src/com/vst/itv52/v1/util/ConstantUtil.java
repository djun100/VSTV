...
public interface ConstantUtil {
	...
	// public final static String TVEXTRA="TVEXTRA" ;

	public final static String LIVE_TID_EXTRA = "tid";
	public final static String LIVE_VID_EXTRA = "vid";
	public final static String LIVE_INDEX_EXTRA = "index";

	public final static String VODEXTRA = "VODEXTRA";

	public final static String VODMEDIA = "VODMEDIA";

	public final static String VIDEODEAIL = "VIDEODEAIL";

	public final static String VIDEOTYPE = "VIDEOTYPE";

	public final static String VIDEOSUB = "VIDEOSUB";

	public final static String VER = "52itv_ver";
